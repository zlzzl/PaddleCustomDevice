...
class TestAdam(OpTest):
    def setUp(self):
        ...
        self.op_type = "adam"
        param = convert_float_to_uint16(np.random.uniform(-1, 1, (102, 105)).astype(self.dtype))
        grad = convert_float_to_uint16(np.random.uniform(-1, 1, (102, 105)).astype(self.dtype))
        moment1 = convert_float_to_uint16(np.random.uniform(-1, 1, (102, 105)).astype(self.dtype))
        # The second moment is positive
        moment2 = convert_uint16_to_float(np.random.random((102, 105)).astype(self.dtype))
        ...
        self.inputs = {
            ...
            "Moment1": moment1,
            "Moment2": moment2,
            "LearningRate": convert_float_to_uint16(np.array([learning_rate]).astype(self.dtype)),
            "Beta1Pow": convert_float_to_uint16(np.array([beta1_pow]).astype(self.dtype)),
            "Beta2Pow": convert_float_to_uint16(np.array([beta2_pow]).astype(self.dtype)),
        }
...
class TestAdamWithEpsilonTensor(OpTest):
    def setUp(self):
        ...
        self.inputs = {
            ...
            "Beta1Pow": convert_float_to_uint16(np.array([beta1_pow]).astype(self.dtype)),
            "Beta2Pow": convert_float_to_uint16(np.array([beta2_pow]).astype(self.dtype)),
            "Beta1Tensor": convert_float_to_uint16(np.array([beta1]).astype(self.dtype)),
            "Beta2Tensor": convert_float_to_uint16(np.array([beta2]).astype(self.dtype)),
            "EpsilonTensor": convert_float_to_uint16(np.array([epsilon]).astype(self.dtype)),
        }
...
class TestAdamOpWithSkipUpdate(OpTest):
    def setUp(self):
        ...
        self.inputs = {
            ...
            "Beta2Tensor": convert_float_to_uint16(np.array([beta2]).astype(self.dtype)),
            "EpsilonTensor": convert_float_to_uint16(np.array([epsilon]).astype(self.dtype)),
            "SkipUpdate": convert_float_to_uint16(np.array([True]).astype("bool")),
        }
...
class TestAdamOpWithGlobalBetaPow(OpTest):
    def setUp(self):
        ...
        moment1 = convert_float_to_uint16(np.random.uniform(-1, 1, (102, 105)).astype(self.dtype))
        # The second moment is positive
        moment2 = convert_float_to_uint16(np.random.random((102, 105)).astype(self.dtype))
